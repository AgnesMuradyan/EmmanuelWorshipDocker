...
const SongDetail = () => {
  ...
  const downloadChords = () => {
    axios.get(`http://localhost:8000/api/songs/${id}/view-chords/`, { responseType: 'blob' })
      .then(response => {
  ...
  const downloadPowerpoint = () => {
    axios.get(`http://localhost:8000/api/songs/${id}/view-powerpoint/`, { responseType: 'blob' })
      .then(response => {
      ...
      <div className="song-detail">
          ...
          {song.chords ? (
              <div className="chords-container">
                  <iframe
                      src={`http://localhost:8000/api/songs/${id}/view-chords/`}
